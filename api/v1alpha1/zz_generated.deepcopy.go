...
func (in *CDAPMasterSpec) DeepCopyInto(out *CDAPMasterSpec) {
	*out = *in
	...
	if in.MetricsSidecar != nil {
		in, out := &in.MetricsSidecar, &out.MetricsSidecar
		*out = new(MetricsSidecarServiceSpec)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsSidecarServiceSpec) DeepCopyInto(out *MetricsSidecarServiceSpec) {
	*out = *in
	in.CDAPScalableServiceSpec.DeepCopyInto(&out.CDAPScalableServiceSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsSidecarServiceSpec.
func (in *MetricsSidecarServiceSpec) DeepCopy() *MetricsSidecarServiceSpec {
	if in == nil {
		return nil
	}
	out := new(MetricsSidecarServiceSpec)
