...
func (in *CDAPMasterSpec) DeepCopyInto(out *CDAPMasterSpec) {
	*out = *in
	...
	if in.TaskDispatcher != nil {
		in, out := &in.TaskDispatcher, &out.TaskDispatcher
		*out = new(TaskDispatcher)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskDispatcher) DeepCopyInto(out *TaskDispatcher) {
	*out = *in
	in.CDAPStatefulServiceSpec.DeepCopyInto(&out.CDAPStatefulServiceSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskDispatcher.
func (in *TaskDispatcher) DeepCopy() *TaskDispatcher {
	if in == nil {
		return nil
	}
	out := new(TaskDispatcher)
