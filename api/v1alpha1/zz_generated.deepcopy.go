...
func (in *CDAPMasterSpec) DeepCopyInto(out *CDAPMasterSpec) {
	*out = *in
	...
	if in.SystemMetricsExporter != nil {
		...
		*out = new(SystemMetricExporterServiceSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *CDAPServiceSpec) DeepCopyInto(out *CDAPServiceSpec) {
	*out = *in
	...
	if in.DisableSystemMetricsSidecar != nil {
		in, out := &in.DisableSystemMetricsSidecar, &out.DisableSystemMetricsSidecar
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SystemMetricExporterServiceSpec) DeepCopyInto(out *SystemMetricExporterServiceSpec) {
	*out = *in
	in.CDAPScalableServiceSpec.DeepCopyInto(&out.CDAPScalableServiceSpec)
	if in.JMXServerPort != nil {
		in, out := &in.JMXServerPort, &out.JMXServerPort
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SystemMetricExporterServiceSpec.
func (in *SystemMetricExporterServiceSpec) DeepCopy() *SystemMetricExporterServiceSpec {
	if in == nil {
		return nil
	}
	out := new(SystemMetricExporterServiceSpec)
